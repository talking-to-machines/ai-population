...
from ai_population.config.digital_twin_config import (
    PROJECT_NAME,
...
if __name__ == "__main__":
    ...
    print("Perform initial interview to idenitfy entity and geographic information.")
    ...
    print("Perform digital election polling of Chile survey participants.")
