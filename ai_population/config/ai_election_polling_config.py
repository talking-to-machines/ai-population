...
POLLED_PROFILES_FILE_X = f"x_polled_profiles.csv"
...
ELIGIBLE_PROFILE_POOL_FILE_X = f"x_eligible_profile_pool_{PIPELINE_EXECUTION_DATE}.csv"
PROFILE_SEARCH_FILE_X = f"x_profile_search_{PIPELINE_EXECUTION_DATE}.csv"
