...
PIPELINE_EXECUTION_DATE = (
    "23-04-2026"  # test  # DD-MM-YYYY  # datetime.today().date().strftime("%d-%m-%Y")
)
...
PROFILE_SEARCH_START_DATE = "04-23-2026"  # MM-DD-YYYY  (Inclusive)
PROFILE_SEARCH_END_DATE = "04-24-2026"  # MM-DD-YYYY format  (Exclusive)
