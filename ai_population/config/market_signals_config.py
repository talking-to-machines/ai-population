...
PIPELINE_EXECUTION_DATE = (
    "12-05-2026"  # test  # DD-MM-YYYY  # datetime.today().date().strftime("%d-%m-%Y")
)
...
PROFILE_SEARCH_START_DATE = "05-12-2026"  # MM-DD-YYYY  (Inclusive)
PROFILE_SEARCH_END_DATE = "05-13-2026"  # MM-DD-YYYY format  (Exclusive)
