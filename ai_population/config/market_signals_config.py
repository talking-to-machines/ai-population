...
PIPELINE_EXECUTION_DATE = (
    "15-03-2026"  # test  # DD-MM-YYYY  # datetime.today().date().strftime("%d-%m-%Y")
)
...
PROFILE_SEARCH_START_DATE = "03-15-2026"  # MM-DD-YYYY  (Inclusive)
PROFILE_SEARCH_END_DATE = "03-16-2026"  # MM-DD-YYYY format  (Exclusive)
