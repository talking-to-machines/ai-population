...
PROFILES_FILE = "market_signals_finfluencer_profiles_nonfinfluencers.txt"
PROFILESEARCH_VIDEO_METADATA_FILE = "profilesearch_video_metadata_nonfinfluencers.csv"
KEYWORDSEARCH_VIDEO_METADATA_FILE = "keywordsearch_video_metadata.csv"
PROFILESEARCH_PROFILE_METADATA_FILE = "profilesearch_profile_metadata_nonfinfluencers.csv"
